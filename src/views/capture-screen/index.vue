<template>
    ...
    >
        <!-- caputure region -->
        <div id="captureRegion" :style="captureRegionStyle" v-show="isCapture"></div>
        <canvas
            id="display-canvas"
            ref="display"
...
<script>
    import ToolBar from 'components/capture/ToolBar'
    import ColorTip from 'components/capture/ColorTip'
    import { captureScreen, setCanvas } from '@/utils/screen-capture'
    ...
    export default {
        ...
        computed: {
            toolbarBottom() {
                ...
                return (
                    this.$root.$data.screenHeight - (this.y + this.height + 60 + 40)
                )
            },
            canvasX() {
